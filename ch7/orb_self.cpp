...
// global variables
string first_file = "/home/ljy/learn_slam14/ch7/1.png";
string second_file = "/home/ljy/learn_slam14/ch7/2.png";
...
void ComputeORB(const cv::Mat &img, vector<cv::KeyPoint> &keypoints, vector<DescType> &descriptors)
{
    ...
    {
        if (kp.pt.x < half_boundary || kp.pt.y < half_boundary || kp.pt.x >= img.cols - half_boundary ||
